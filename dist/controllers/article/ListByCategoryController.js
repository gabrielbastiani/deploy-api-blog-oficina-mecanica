...
const ListByCategoryService_1 = require("../../services/article/ListByCategoryService");
class ListByCategoryController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const articles = yield listByCategoryService.execute(Number(page), Number(limit), categoryName);
